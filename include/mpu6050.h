...
float accelScaleFactor = 9.80665*0.957113773;                  //9.81/8192.09 9.81 / 8205
...
void mpu6050_initialize()
{
    ...
    Wire.write((uint8_t)0x00);              //// Sample rate = 1kHz
    Wire.endTransmission();
    delay(5);
    Wire.beginTransmission(MPU6050_ADDRESS);
    ...
    Wire.write((uint8_t)0x10); //0x10 = 1G=256, AFS_SEL=2 (0x00 = +/-2G)  1G = 16,384 //0x10 = 1G = 4096 ,//0x08 = +-4g
    Wire.endTransmission();
    delay(5);
    Wire.beginTransmission(MPU6050_ADDRESS);
    Wire.write(MPUREG_INT_PIN_CFG); // enable I2C bypass for AUX I2C
    Wire.write((uint8_t)0x02);               //I2C_BYPASS_EN=1
    Wire.endTransmission();
...
static inline void mpu6050_Gyro_Values()
{
    Wire.beginTransmission(MPU6050_ADDRESS);
...
static inline void mpu6050_Accel_Values()
{
    Wire.begin();
    Wire.beginTransmission(MPU6050_ADDRESS);
...
static inline void mpu6050_readGyroSum()
{
    mpu6050_Gyro_Values();
...
static inline void mpu6050_Get_gyro()
{
    // Calculate average
...
static inline void mpu6050_readAccelSum()
{
...
static inline void mpu6050_Get_accel()
{
    // Calculate average
    if (gyroSamples == 0)
    {
